...
в папках лежат исходники, бинарь и файл установщика
...
#### 1. Скачать папку amd или intel в зависимости от процессора

Войти в папку и запустить установщик:

```
sudo ./install.sh
```

После установки папку можно удалять
